...
const ForgotPassword = () => {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            if (!res.success) {
                setError(res.message || "Something went wrong. Please try again later.");
                return;
            }
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6 my-4">
                            ...
                            <div className="flex justify-center items-center text-sm">
                                <p>Want to login? </p>&nbsp;<Link className="text-amber-700 hover:underline cursor-pointer mr-1" href="/admin/login">Login</Link>
                            </div>
                        </form>
                    </CardContent>
                </Card>
